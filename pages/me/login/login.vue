<template>
	<view>
		...
		<view class="main1">
			...
			<view class="title text-black margin-bottom text-lg">欢迎登录GS商城</view>
			<view class="item">
		...
		<view class="btn_login bg-red" @click="startLogin">登录</view>
		<!-- 底部信息 -->
		<view class="footer" style="margin-top: 16px">
			<view @click="goPgeRegister">
				<text>新用户注册</text>
			</view>
